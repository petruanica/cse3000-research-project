...
def get_curve_with_ci(test, ite_pred):
    test = test.assign(ite=ite_pred)
    gain_curve = cumulative_gain(test, "ite", y="mort_28", t="peep_regime", min_periods=0)
    gain_curve_ci = cumulative_gain_ci(test, "ite", y="mort_28", t="peep_regime", min_periods=0)
